...
#NOTE- I included results='hide' for this chunk because my knitted PDF was displaying 
#every value in my filtered dataset for #4,and I wasn;t sure how to turn it off. 
#I don't believe it affected any other aspects here.
...
#Since removing depth seems to drive up the AIC by the largest amount, it would seem that depth is best suited to predict temperature. However, all variables, when removed, do drive the AIC up, at least by a bit.
